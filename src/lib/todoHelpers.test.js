...
test('addTodo should add the passed todo to the list', () => {
   const startTodos = [
      ...
      { id: 2, name: 'one', isComplete: false },
   ]
...
test('updateTodo should update an item by id', () => {
   ...
   const updatedTodo = { id: 2, name: 'one', isComplete: true }
   const expectedTodos = [
      { id: 1, name: 'one', isComplete: false },
      { id: 2, name: 'one', isComplete: true },
      { id: 3, name: 'three', isComplete: false }
   ]
...
test('filterTodos should return only uncompleted items for the active route', () => {
   const startTodos = [
      { id: 1, name: 'one', isComplete: false },
      { id: 2, name: 'one', isComplete: true },
      { id: 3, name: 'three', isComplete: false }
